...
The [OpenTracing](http://opentracing.io/documentation/) standard has the concept of baggage
...
To support attributes defined in this standard, we use the % character followed 
